    ...
    <form action="includes/functions.php" method="POST">
        <div class="form-grid">
            ...
            <span>
                ...
                <input type="text" name="cvsuEmail" id="">
            </span>

            <span>
                <label for="">Home Number / Blk & Lot</label>

                <input type="text" name="addressA" id="">
            </span>
            <span>
                <label for="">Street / Barangay</label>

                <input type="text" name="addressB" id="">
            </span>
            <span>
                <label for="">City / Town</label>

                <input type="text" name="addressC" id="">
            </span>
            <span>
                <label for="">Province</label>

                <input type="text" name="addressD" id="">
            </span>
            ...
            <span>
                ...
                <select name="campus" id="">
                    ...
                    <option value="Silang">Silang Campus</option>
            ...
            <span>
                ...
                <input type="text" name="prevProgram" id="" placeholder="SHS - STEM, SHS - TVL, Junior High School">
            </span>
            <span>
                <label for="">School</label>
                <input type="text" name="prevSchool" id="">
            </span>
            ...
            <span>
                <label for="">Contact Number</label>
                <input type="text" name="fathersContact" id="" onkeypress="return onlyNumberKey(event)" maxlength="13">
            </span>
            ...
            <span>
                ...
                <input type="text" name="fathersAddress" id="">
            </span>
            <span>
            ...
            <span>
                <label for="">Address</label>
                <input type="text" name="mothersAddress" id="">
            </span>
